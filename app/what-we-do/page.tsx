...
export const metadata: Metadata = {
  title: "What We Do | Criminal Defence Kent | Police Station Representation",
  description: "Expert police station representation and criminal defence services across Kent. Available 24/7 for arrests, voluntary interviews, and legal advice.",
  alternates: {
      ...
      <main className="min-h-screen bg-white">
        <div className="container mx-auto px-4 py-8">
          <div className="prose prose-lg max-w-none">
            <div dangerouslySetInnerHTML={{ __html: `<div class="bg-gradient-to-br from-slate-50 to-blue-50">
