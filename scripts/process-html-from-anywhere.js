...
function extractMetadata(html) {
  ...
  return {
    title: document.querySelector('title')?.textContent?.trim() || 'Services for Clients | Police Station Agent',
    description: document.querySelector('meta[name="description"]')?.getAttribute('content') || '',
    canonical: document.querySelector('link[rel="canonical"]')?.getAttribute('href') || 'https://policestationagent.com/for-clients',
  };
}
...
async function main() {
  ...
  if (!filePath) {
    ...
    console.log('\nExample:');
    console.log('  node scripts/process-html-from-anywhere.js "C:\\Users\\rober\\Downloads\\Services for Clients.html"');
