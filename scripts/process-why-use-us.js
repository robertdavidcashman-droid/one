...
function extractMetadata(html) {
  ...
  return {
    title: document.querySelector('title')?.textContent?.trim() || 'Why Use Us As Your Police Station Agent In Kent | Police Station Agent',
    description: document.querySelector('meta[name="description"]')?.getAttribute('content') || 'Discover why Police Station Agent is the trusted choice for expert police station representation in Kent. Available 24/7.',
    canonical: document.querySelector('link[rel="canonical"]')?.getAttribute('href') || 'https://policestationagent.com/why-use-us',
  };
}
