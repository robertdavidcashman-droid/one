...
function extractMetadata(html) {
  ...
  return {
    title: document.querySelector('title')?.textContent?.trim() || 'Can We Help You? | Interactive Guide | Police Station Agent',
    description: document.querySelector('meta[name="description"]')?.getAttribute('content') || '',
    canonical: document.querySelector('link[rel="canonical"]')?.getAttribute('href') || 'https://policestationagent.com/canwehelp',
  };
}
